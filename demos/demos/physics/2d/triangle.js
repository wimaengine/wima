...
export const triangle = new Demo('triangle', [spawnBox, spawnGround, adjust2DGravity])
...
function spawnBox(world) {
  ...
  commands
    ...
    .insert(meshes.add('physical', Mesh.triangle2D(100, 100)))
    .insert(Collider2D.triangle(100, 100))
